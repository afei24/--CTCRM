...
{
    /// <summary>
    /// WlbWmsConsignInventoryReleaseResponse.
    /// </summary>
    public class WlbWmsConsignInventoryReleaseResponse : TopResponse
    {
        /// <summary>
        /// 接口返回model
        /// </summary>
...
public class IteminventoryDomain : TopObject
{
	        ...
	        /// 释放库存数量
	        /// </summary>
	        [XmlElement("item_release_qty")]
	        public long ItemReleaseQty { get; set; }
