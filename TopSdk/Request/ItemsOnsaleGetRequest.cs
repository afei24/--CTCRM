...
namespace Top.Api.Request
{
    ...
    /// </summary>
    public class ItemsOnsaleGetRequest : BaseTopRequest<Top.Api.Response.ItemsOnsaleGetResponse>
    {
        /// <summary>
        ...
        /// 组合商品
        /// </summary>
        public Nullable<bool> IsCombine { get; set; }
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("is_combine", this.IsCombine);
