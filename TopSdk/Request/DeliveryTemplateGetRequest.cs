...
namespace Top.Api.Request
{
    ...
    /// </summary>
    public class DeliveryTemplateGetRequest : BaseTopRequest<Top.Api.Response.DeliveryTemplateGetResponse>
    {
        /// <summary>
        ...
        public override void Validate()
        {
            ...
            RequestValidator.ValidateMaxListSize("template_ids", this.TemplateIds, 20);
        }
