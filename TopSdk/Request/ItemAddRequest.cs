...
namespace Top.Api.Request
{
    ...
    /// </summary>
    public class ItemAddRequest : BaseTopRequest<ItemAddResponse>, ITopUploadRequest<ItemAddResponse>
    {
        /// <summary>
        /// 售后说明模板id
        /// </summary>
        ...
        /// </summary>
        public string DeliveryTimeDeliveryTime { get; set; }

        /// <summary>
        /// 发货时间类型：绝对发货时间或者相对发货时间
        /// </summary>
        public string DeliveryTimeDeliveryTimeType { get; set; }

        /// <summary>
        /// 设置是否使用发货时间，商品级别，sku级别
        /// </summary>
        public string DeliveryTimeNeedDeliveryTime { get; set; }
        ...
        /// </summary>
        public Nullable<bool> GlobalStockTaxFreePromise { get; set; }
        ...
        /// </summary>
        public string LocalityLifeEticket { get; set; }
        ...
        /// 预约门店是否支持门店自提,1:是
        /// </summary>
        public string LocalityLifeObs { get; set; }
        ...
        /// 新版电子凭证包 id
        /// </summary>
        public string LocalityLifePackageid { get; set; }
        ...
        /// 新版电子凭证字段
        /// </summary>
        public string LocalityLifeVersion { get; set; }
        ...
        /// 此参数暂时不起作用
        /// </summary>
        public string SkuDeliveryTimes { get; set; }
        ...
        /// 手机类目spu 优化，信息确认字段
        /// </summary>
        public Nullable<bool> SpuConfirm { get; set; }
        ...
        /// </summary>
        public Nullable<bool> SupportCustomMade { get; set; }
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("cpv_memo", this.CpvMemo);
            parameters.Add("custom_made_type_id", this.CustomMadeTypeId);
            parameters.Add("delivery_time.delivery_time", this.DeliveryTimeDeliveryTime);
            parameters.Add("delivery_time.delivery_time_type", this.DeliveryTimeDeliveryTimeType);
            parameters.Add("delivery_time.need_delivery_time", this.DeliveryTimeNeedDeliveryTime);
            ...
            parameters.Add("global_stock_delivery_place", this.GlobalStockDeliveryPlace);
            parameters.Add("global_stock_tax_free_promise", this.GlobalStockTaxFreePromise);
            ...
            parameters.Add("input_custom_cpv", this.InputCustomCpv);
            ...
            parameters.Add("locality_life.eticket", this.LocalityLifeEticket);
            ...
            parameters.Add("locality_life.obs", this.LocalityLifeObs);
            parameters.Add("locality_life.onsale_auto_refund_ratio", this.LocalityLifeOnsaleAutoRefundRatio);
            parameters.Add("locality_life.packageid", this.LocalityLifePackageid);
            ...
            parameters.Add("locality_life.version", this.LocalityLifeVersion);
            parameters.Add("location.city", this.LocationCity);
            parameters.Add("location.state", this.LocationState);
            parameters.Add("ms_payment.price", this.MsPaymentPrice);
            parameters.Add("ms_payment.reference_price", this.MsPaymentReferencePrice);
            parameters.Add("ms_payment.voucher_price", this.MsPaymentVoucherPrice);
            ...
            parameters.Add("sku_delivery_times", this.SkuDeliveryTimes);
            ...
            parameters.Add("spu_confirm", this.SpuConfirm);
            parameters.Add("stuff_status", this.StuffStatus);
            parameters.Add("sub_stock", this.SubStock);
            parameters.Add("support_custom_made", this.SupportCustomMade);
