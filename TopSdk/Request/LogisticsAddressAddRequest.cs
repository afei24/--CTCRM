...
namespace Top.Api.Request
{
    ...
    /// </summary>
    public class LogisticsAddressAddRequest : BaseTopRequest<Top.Api.Response.LogisticsAddressAddResponse>
    {
        /// <summary>
        /// 详细街道地址，不需要重复填写省/市/区
        /// </summary>
        ...
        public override void Validate()
        {
            ...
            RequestValidator.ValidateMaxLength("memo", this.Memo, 256);
            RequestValidator.ValidateRequired("province", this.Province);
            RequestValidator.ValidateMaxLength("seller_company", this.SellerCompany, 20);
        }
