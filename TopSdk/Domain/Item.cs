...
namespace Top.Api.Domain
{
    ...
    public class Item : TopObject
    {
        ...
        public Top.Api.Domain.CuntaoItemSpecific CuntaoItemSpecific { get; set; }
        ...
        public Top.Api.Domain.DeliveryTime DeliveryTime { get; set; }
        ...
        public Top.Api.Domain.DescModuleInfo DescModuleInfo { get; set; }
        ...
        public Top.Api.Domain.FoodSecurity FoodSecurity { get; set; }
        ...
        public Top.Api.Domain.LocalityLife LocalityLife { get; set; }
        ...
        public Top.Api.Domain.MpicVideo MpicVideo { get; set; }

        /// <summary>
        /// 家装分阶段价格数据结构
        /// </summary>
        [XmlElement("ms_payment")]
        public Top.Api.Domain.MsPayment MsPayment { get; set; }
        ...
        public Top.Api.Domain.PaimaiInfo PaimaiInfo { get; set; }
