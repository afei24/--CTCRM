...
namespace Top.Api.Domain
{
    ...
    public class FenxiaoProduct : TopObject
    {
        ...
        public List<Top.Api.Domain.FenxiaoImage> Images { get; set; }
        ...
        public List<Top.Api.Domain.FenxiaoPdu> Pdus { get; set; }
        ...
        public List<Top.Api.Domain.FenxiaoSku> Skus { get; set; }
