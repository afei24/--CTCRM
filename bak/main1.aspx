<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main1.aspx.cs" Inherits="CTCRM.main" %>
        ...
        <div class="div_logo">
         ...
         <div class="div_user">
               <div class="div_user_img">
                   <ul  style="margin:0;background-color:#2F3A4C;">
                       <li class="li_user"><img class="img_touxiang" src="/Images/touxiang.PNG" />&nbsp<b class="f_user"><%=userName%></b></li>
                   </ul>
               </div> 
         </div>
         <ul class="ul_left_navigation" style="padding:0;margin:0;"> 
              ...
              <li class="li_navigation" id="index"><img class="tubiao" id="Win_Image/物流" src="Win_Image/物流.png" />物流提醒<img class="三角形左" src="Win_Image/三角形左.png" /></li>
                <li class="li_navigation2 index" id="member/index.aspx">会员关怀</li>
                <li class="li_navigation2 index" id="member/reminderHis.aspx">提醒记录</li>
              <li class="li_navigation" id="message"><img class="tubiao" id="Win_Image/营销" src="Win_Image/营销.png" />短信营销<img class="三角形左" src="Win_Image/三角形左.png" /></li>
              ...
              <li class="li_navigation" id="messageSetting"><img class="tubiao" id="Win_Image/短信" src="Win_Image/短信.png" />短信订购<img class="三角形左" src="Win_Image/三角形左.png" /></li>
                  <li class="li_navigation2 messageSetting" id="messageSetting.aspx">短信订购</li>              
              <li class="li_navigation" id="rateSetting"><img class="tubiao" id="Win_Image/评价" src="Win_Image/评价.png" />自动评价<img class="三角形左" src="Win_Image/三角形左.png" /></li>
              ...
              <li class="li_msg" id="li_version">当前版本：<%=orderVersion%></li>
              <li class="li_msg" id="li_msgNumber">短信剩余条数:</li>
              <li class="li_msg" id="li_duetime">服务到期时间:<%=deadline%></li>
              <li class="li_msg" style="color:#04ADD3;" onclick="xuyue();">点击续约</li>
          </ul>
    </div>
    <iframe class="iframe_main" src="/WIN_Aspx/home.aspx">
    </iframe>
