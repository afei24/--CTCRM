...
namespace CTCRM.DAL
{
    public class LogisticsDAL
    {
        ...
        public static string getLogisticsStatusByTid(string tid)
        {
            try
            {
                string query = @"select action from tab_logistics where tid=@tid and ";
        ...
        public static DataTable getLogIsticsList()
        {
            try
            {
                string query = @"select * from tab_logistics order by time desc ";
