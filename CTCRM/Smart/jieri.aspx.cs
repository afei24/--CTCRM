...
namespace CTCRM.Smart
{
    public partial class jieri : System.Web.UI.Page
    {
        ...
        {
            string date = DateTime.Now.AddYears(-1).Year.ToString() + "-02-14";
            string date2 = DateTime.Now.Year.ToString() + "-02-14";
            DataTable tb = SmartBLL.GetHuoDongBuyersCount(date, Users.SellerId, date2);
            if (tb != null && tb.Rows.Count > 0)
            {
        ...
        {
            string date = DateTime.Now.AddYears(-1).Year.ToString() + "-03-18";
            string date2 = DateTime.Now.Year.ToString() + "-03-18";
            DataTable tb = SmartBLL.GetHuoDongBuyersCount(date, Users.SellerId, date2);
            if (tb != null && tb.Rows.Count > 0)
            {
        ...
        {
            string date = DateTime.Now.AddYears(-1).Year.ToString() + "-05-01";
            string date2 = DateTime.Now.Year.ToString() + "-05-01";
            DataTable tb = SmartBLL.GetHuoDongBuyersCount(date, Users.SellerId, date2);
            if (tb != null && tb.Rows.Count > 0)
            {
        ...
        {
            string date = DateTime.Now.AddYears(-1).Year.ToString() + "-06-17";
            string date2 = DateTime.Now.Year.ToString() + "-06-17";
            DataTable tb = SmartBLL.GetHuoDongBuyersCount(date,Users.SellerId,date2);
            if (tb != null && tb.Rows.Count > 0)
            {
        ...
        {
            string date = DateTime.Now.AddYears(-1).Year.ToString() + "-08-23";
            string date2 = DateTime.Now.Year.ToString() + "-08-23";
            DataTable tb = SmartBLL.GetHuoDongBuyersCount(date, Users.SellerId, date2);
            if (tb != null && tb.Rows.Count > 0)
            {
        ...
        {
            string date = DateTime.Now.AddYears(-1).Year.ToString() + "-09-30";
            string date2 = DateTime.Now.Year.ToString() + "-09-30";
            DataTable tb = SmartBLL.GetHuoDongBuyersCount(date, Users.SellerId, date2);
            if (tb != null && tb.Rows.Count > 0)
            {
        ...
        {
            string date = DateTime.Now.AddYears(-1).Year.ToString() + "-10-01";
            string date2 = DateTime.Now.Year.ToString() + "-10-01";
            DataTable tb = SmartBLL.GetHuoDongBuyersCount(date, Users.SellerId, date2);
            if (tb != null && tb.Rows.Count > 0)
            {
        ...
        {
            string date = DateTime.Now.AddYears(-1).Year.ToString() + "-11-11";
            string date2 = DateTime.Now.Year.ToString() + "-11-11";
            DataTable tb = SmartBLL.GetHuoDongBuyersCount(date, Users.SellerId, date2);
            if (tb != null && tb.Rows.Count > 0)
            {
        ...
        {
            string date = DateTime.Now.AddYears(-1).Year.ToString() + "-12-12";
            string date2 = DateTime.Now.Year.ToString() + "-12-12";
            DataTable tb = SmartBLL.GetHuoDongBuyersCount(date, Users.SellerId, date2);
            if (tb != null && tb.Rows.Count > 0)
            {
        ...
        {
            string date = DateTime.Now.AddYears(-1).Year.ToString() + "-12-25";
            string date2 = DateTime.Now.Year.ToString() + "-12-25";
            DataTable tb = SmartBLL.GetHuoDongBuyersCount(date, Users.SellerId, date2);
            if (tb != null && tb.Rows.Count > 0)
            {
