<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="memberLevel.aspx.cs" MasterPageFile="~/Temp/Common.Master" Inherits="CTCRM.Smart.memberLevel" %>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3" style="width: 30%">
                                        <asp:Label ID="Label8" runat="server" Text="推荐指数" Font-Bold="true" Font-Size="10pt"
                                            ForeColor="#00BFE9"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%" align="center">
                                        <asp:ImageButton ID="imgbtnPuTongBuyer" runat="server" ImageUrl="~/Images/getUser.png" OnClientClick="dialog.DOpen(this);"
                                            OnClick="imgbtnPuTongBuyer_Click" /><asp:Label ID="lbPuTongBuyerCount" Font-Bold="true"
                                                Font-Size="16px" runat="server" Text=""></asp:Label>
                                    </td>
                                    <td style="width: 10%">
                                        <a href="javascript:void(0)" style="text-decoration: none" onclick="$('#dlg').dialog('open');setType('puTongBuyer')"><img src="../Images/msgSend1.png" /></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 70%">
                                    ...
                                    <td colspan="3" style="width: 30%">
                                        <asp:Label ID="Label10" runat="server" Text="推荐指数" Font-Bold="true" Font-Size="10pt"
                                            ForeColor="#00BFE9"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%" align="center">
                                        <asp:ImageButton ID="imgbtnGaoJiBuyerCount" runat="server" ImageUrl="~/Images/getUser.png" OnClientClick="dialog.DOpen(this);"
                                            OnClick="imgbtnGaoJiBuyerCount_Click" /><asp:Label ID="lbGaoJiBuyersCount" Font-Bold="true"
                                                Font-Size="16px" runat="server" Text=""></asp:Label>
                                    </td>
                                    <td style="width: 10%">
                                        <a href="javascript:void(0)" style="text-decoration: none" onclick="$('#dlg').dialog('open');setType('gaoJiBuyer')"><img src="../Images/msgSend1.png" /></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 70%">
                                    ...
                                    <td colspan="3" style="width: 30%">
                                        <asp:Label ID="Label12" runat="server" Text="推荐指数" Font-Bold="true" Font-Size="10pt"
                                            ForeColor="#00BFE9"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%" align="center">
                                        <asp:ImageButton ID="imgbtnVIPBuyersCount" runat="server" ImageUrl="~/Images/getUser.png" OnClientClick="dialog.DOpen(this);"
                                            OnClick="imgbtnVIPBuyersCount_Click" /><asp:Label ID="lbVIPBuyersCount" Font-Bold="true"
                                                Font-Size="16px" runat="server" Text=""></asp:Label>
                                    </td>
                                    <td style="width: 10%">
                                        <a href="javascript:void(0)" style="text-decoration: none" onclick="$('#dlg').dialog('open');setType('vipBuyer')"><img src="../Images/msgSend1.png" /></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 70%">
                                    ...
                                    <td colspan="3" style="width: 30%">
                                        <asp:Label ID="Label14" runat="server" Text="推荐指数" Font-Bold="true" Font-Size="10pt"
                                            ForeColor="#00BFE9"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%" align="center">
                                        <asp:ImageButton ID="imgbtnGoJiVIP" runat="server" ImageUrl="~/Images/getUser.png" OnClientClick="dialog.DOpen(this);"
                                            OnClick="imgbtnGoJiVIP_Click" /><asp:Label ID="lbGaoJiVIPBuyersCount" Font-Bold="true"
                                                Font-Size="16px" runat="server" Text=""></asp:Label>
                                    </td>
                                    <td style="width: 10%">
                                        <a href="javascript:void(0)" style="text-decoration: none" onclick="$('#dlg').dialog('open');setType('gaoJiVIPBuyer')"><img src="../Images/msgSend1.png" /></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
