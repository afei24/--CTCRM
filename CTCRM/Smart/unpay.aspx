                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3" style="width: 30%" class="head">
                                        <asp:Label ID="Label49" runat="server" Text="推荐指数" Font-Bold="true" Font-Size="11pt"
                                            ></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%" align="center">
                                        <asp:ImageButton ID="btnimgunpay" runat="server" ImageUrl="../../Win_Image/会员营销的赛选会员.jpg" OnClientClick="dialog.DOpen(this);"
                                            OnClick="btnimgunpay_Click" /><asp:Label ID="lbunpay" Font-Bold="true" Font-Size="16px"
                                                runat="server" Text=""></asp:Label>
                                    </td>
                                    <td style="width: 10%">
                                        <a href="javascript:void(0)" style="text-decoration: none" onclick="$('#dlg').dialog('open');setType('unpay')"><img src="../../Win_Image/会员营销的短信营销.jpg" /></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 70%" class="head">
                                    ...
                                    <td colspan="3" style="width: 30%" class="head">
                                        <asp:Label ID="Label51" runat="server" Text="推荐指数" Font-Bold="true" Font-Size="11pt"
                                            ></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%" align="center">
                                        <asp:ImageButton ID="imgbtnunpay7days" runat="server" ImageUrl="../../Win_Image/会员营销的赛选会员.jpg" OnClientClick="dialog.DOpen(this);"
                                            OnClick="imgbtnunpay7days_Click" /><asp:Label ID="lbunpay7days" Font-Bold="true"
                                                Font-Size="16px" runat="server" Text=""></asp:Label>
                                    </td>
                                    <td style="width: 10%">
                                         <a href="javascript:void(0)" style="text-decoration: none" onclick="$('#dlg').dialog('open');setType('unpay7days')"><img src="../../Win_Image/会员营销的短信营销.jpg" /></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
