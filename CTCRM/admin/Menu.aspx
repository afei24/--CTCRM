                ...
                <div class="leftMain">
                    ...
                    <div class="cdan">
                        <dl>
                            <dt class="lbj1"><a class="nav" href="javascript:void(0)" onclick="CloseExtend(this)">
                              ...
                              <dd style="display: block">
                                <s></s><a onfocus="this.blur();" href="message/rechargeRecords.aspx" target="rightFrame">管理员充值记录</a></dd>
                            <dd style="display: block">
                                <s></s><a onfocus="this.blur();" href="message/SellerRecords.aspx" target="rightFrame">卖家订购软件记录</a></dd>
                            <dd style="display: block">
                                <s></s><a onfocus="this.blur();" href="message/MsgPackageRecords.aspx" target="rightFrame">卖家短信包记录</a></dd>
                             <dd style="display: block">
                            ...
                            <dd style="display: block">
                             ...
                             <dd style="display: block">
                                <s></s><a onfocus="this.blur();" href="MsgTem.aspx" target="rightFrame">短信模版管理</a></dd>
                        </dl>
                        <dl>
                            <dt class="lbj1"><a class="nav" href="javascript:void(0)" onclick="CloseExtend(this)">
                            ...
                            <dd style="display: none">
                                <s></s><a onfocus="this.blur();" href="memberData/buyerlist.aspx" target="rightFrame">会员下载</a></dd> 
                            <dd style="display: none">
                                <s></s><a onfocus="this.blur();" href="memberData/buyer_application.aspx" target="rightFrame">卖家会员下载申请</a></dd> 
                        ...
                        <dl>
                            ...
                            <dd class="fgx" style="display: none">
                                <s></s><a onfocus="this.blur();" href="notify/index.aspx" target="rightFrame" onclick="return false;">通知管理</a></dd>
                             <dd class="fgx" style="display: none">
                                <s></s><a onfocus="this.blur();" href="notify/allCus.aspx" target="rightFrame" onclick="return false;">API通知管理</a></dd>
                               <dd class="fgx" style="display: none">
                         ...
                         <dl>
                            ...
                            <dd class="fgx" style="display: none">
                             ...
                             <dd class="fgx" style="display: none">
                                <s></s><a onfocus="this.blur();" href="logtics/logtics.aspx" target="rightFrame">物流名单</a></dd> 
                        </dl>
                        ...
                        <dl>
                            <dt class="lbj1"><a class="nav" href="javascript:void(0)" onclick="CloseExtend(this)">
                                &nbsp;&nbsp;<span style="cursor: pointer;"> 系统管理 </span><s class="ps1"></s></a>
                            </dt>
                             <dd class="fgx" style="display: none">
                                <s></s><a onfocus="this.blur();" href="system/SystemMessages.aspx" target="rightFrame">系统公告管理</a></dd> 
                        </dl>
