<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MsgPackageRecords.aspx.cs" Inherits="CTCRM.admin.message.MsgPackageRecords" %>
                ...
                <tr>
                    ...
                    <td class="auto-style9">
                        <asp:DropDownList ID="drpStaus" Width="125px" runat="server">
                            ...
                            <asp:ListItem>短信套餐(赠送)</asp:ListItem>
                            <asp:ListItem>短信套餐(手动添加)</asp:ListItem>
                            <asp:ListItem>短信套餐(短信充值)</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td >
        ...
        <div class="nrkuai">
            ...
            <asp:GridView ID="gd_All" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="packageName" HeaderText="短信套餐名称">
                    ...
                    <asp:BoundField DataField="type" HeaderText="使用期限类型" />
                    <asp:BoundField DataField="useDays" HeaderText="可使用天数" />
                    <asp:BoundField DataField="price" HeaderText="价格" />
                    <asp:BoundField DataField="perprice" HeaderText="单价" />
                    <asp:BoundField DataField="rank" HeaderText="套餐类型" />
