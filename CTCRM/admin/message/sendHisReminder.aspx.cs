...
{
    public partial class sendHisReminder : System.Web.UI.Page
    {
        public DataTable dtMsgCount = MsgBLL.GetMsgSendHisForReminderCount("");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (MsgBLL.DeleteMsgHisForReminder(sellerNick, txt_StartTime1.Value, txt_EndTime1.Value, drpSendType.SelectedValue))
            {
        ...
        protected void Btn_SelectCount_Click(object sender, EventArgs e)
        {
            ...
            DataTable tb = MsgBLL.GetMsgSendHisForReminderCount(buyer);
