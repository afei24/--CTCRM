                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td style="border:none;" colspan="2">
                                    <br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、<a style="color:#00BFE9" target="_blank"  href="http://tradearchive.taobao.com/trade/itemlist/list_export_order.htm">点击此处直接进入淘宝下载历史订单</a>（这个链接等同于如下操作：进入淘宝卖家的”已卖出宝贝“页面，点击最后一栏的”三个月前订单“，点击上面的”导出/下载历史订单“按钮）。<br />
                                    <br />
                            ...
                            <tr>
                                <td style="border:none;" align="left" colspan="2">
                                    <br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font>选择第一步保存的订单信息文件，点击上传按钮(不要做任何更改，店铺管家只识别从淘宝直接导出的数据格式)(也不要做打开保存动作，打开后即使不做任何修改，文件格式也变了)，</font><br/>
                                    <br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font>店铺管家将自动提取客户电子邮件、手机、交易等信息。</font><br />
                                    <br />
