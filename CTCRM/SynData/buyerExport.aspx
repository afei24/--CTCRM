        ...
        <div class="homediv">
            <%--<div class="hmenu">
                ...
                <ul class="items">
                    ...
                    <li class="on"><a href="downloads.aspx">客户资料补全</a></li>
                    <li class="active"><a href="buyerExport.aspx">客户资料导出</a></li>
                ...
                <div class="pDiv2">
                    ...
                    <div class="contt4">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="font-size: 13px; color: #00BFE9; font-weight: bold">&nbsp;&nbsp;温馨提示：导出数据过程中不要关闭页面，如果您店铺的会员比较多，那么请耐心等待，下载完成后系统将提示已经完成。
                                </td>
                            </tr>
                            <tr>
