<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="area.aspx.cs" MasterPageFile="~/Temp/Common.Master" Inherits="CTCRM.Smart.area" %>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3" style="width: 30%">
                                        <asp:Label ID="Label54" runat="server" Text="推荐指数" Font-Bold="true" Font-Size="10pt"
                                            ForeColor="#E17009"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%" align="center">
                                        <asp:ImageButton ID="btnimgBaiFang" runat="server" ImageUrl="~/Images/getUser.png" OnClientClick="dialog.DOpen(this);"
                                            OnClick="btnimgBaiFang_Click" /><asp:Label ID="lbBaiFang" Font-Bold="true" Font-Size="16px"
                                                runat="server" Text=""></asp:Label>
                                    </td>
                                    <td style="width: 10%">
                                        <a href="javascript:void(0)" style="text-decoration: none" onclick="$('#dlg').dialog('open');setType('baifang')"><img src="../Images/msgSend1.png" /></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 70%">
                                    ...
                                    <td colspan="3" style="width: 30%">
                                        <asp:Label ID="Label56" runat="server" Text="推荐指数" Font-Bold="true" Font-Size="10pt"
                                            ForeColor="#E17009"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%" align="center">
                                        <asp:ImageButton ID="imgbtnNanfang" runat="server" ImageUrl="~/Images/getUser.png" OnClientClick="dialog.DOpen(this);"
                                            OnClick="imgbtnNanfang_Click" /><asp:Label ID="lbNanfang" Font-Bold="true" Font-Size="16px"
                                                runat="server" Text=""></asp:Label>
                                    </td>
                                    <td style="width: 10%">
                                        <a href="javascript:void(0)" style="text-decoration: none" onclick="$('#dlg').dialog('open');setType('nanfang')"><img src="../Images/msgSend1.png" /></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
