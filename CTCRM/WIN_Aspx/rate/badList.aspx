<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="badList.aspx.cs" Inherits="CTCRM.WIN_Aspx.rate.badList" %>
            ...
            <div class="righter">
                <div class="pDiv2">
                    <div class="div_zhandian">
                        <span class="zhandian">自动评价 >> 中差评查询</span>
                    </div>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td align="center" valign="middle">
                                    <asp:ImageButton ID="btnimgSearch" runat="server" Width="80px" Height="25px" ImageUrl="~/Images/search.png"
