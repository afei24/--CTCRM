<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="CTCRM.WIN_Aspx.member.index" %>
        ...
        <div class="homediv">
            ...
            <div class="righter">
                         ...
                         <div class="ui-state-error ui-corner-all" style="width: 99%; text-align: left; font-size: 17px; font-weight: bold; vertical-align: middle">
                            <strong>&nbsp;注意！！</strong>千万记得开启获取数据授权哟<asp:ImageButton ID="btnAuothOpen" runat="server"
                                ...
                                OnClientClick="dialog.DOpen(this)" />&nbsp;<asp:HyperLink ID="versionControl" Font-Bold="true" Font-Size="16px" Target="_blank"
                                    ...
                                    Text="仅限正式版用户,现在去升级？"></asp:HyperLink>&nbsp;<asp:Label ID="lberror" ForeColor="#00BFE9"
                ...
                <div class="pDiv2">
                    ...
                    <div class="contt4 notpaying contt4_2">    
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:RadioButton ID="rdoUnpayCus" GroupName="unpay" Text="我要自己设置提醒内容【<font color=red>提醒内容可选参数：**下单时间**|**收货人**</font>】<font color=#00BFE9>自定义提醒内容设置后请联系客服备案，否则不成功！<font color=red>" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="title2 pay contt4_2">
                          <asp:Label ID="Label10" runat="server" Text="付款关怀提醒" Font-Bold="true" Font-Size="12pt"
                                ForeColor="#00BFE9"></asp:Label>【<font style="color: #00BFE9">买家付款时，发短信给买家</font>】
                     </div>
                    <div class="contt4 pay contt4_2">
                            <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 20%; vertical-align: middle">
...
不贪玩，一般2到5天就会飞奔到你了身边了哦"
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:RadioButton ID="rdoPayTypeCus" GroupName="pay" Text="我要自己设置提醒内容【<font color=red>提醒内容可选参数：**收货人**|**下单时间**</font>】<font color=#00BFE9>自定义提醒内容设置后请联系客服备案，否则不成功！<font color=red>" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="title2 delivery contt4_2">
                      <asp:Label ID="Label15" runat="server" Text="发货提醒" Font-Bold="true" Font-Size="12pt"
                                ForeColor="#00BFE9"></asp:Label>【<font style="color: #00BFE9">点发货后，自动发短信给买家</font>】
                     </div>
                    <div class="contt4 delivery contt4_2">                    
                      <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 20%; vertical-align: middle">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:RadioButton ID="rdoShiping" GroupName="1" Text="我要自己设置提醒内容【<font color=red>提醒内容可选参数：**发货时间**|**快递公司**|**快递单号**|**收货人**</font>】<font color=#00BFE9>自定义提醒内容设置后请联系客服备案，否则不成功！<font color=red>" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="title2 delay contt4_2">
                      <asp:Label ID="Label19" runat="server" Text="延迟发货提醒" Font-Bold="true" Font-Size="12pt"
                                ForeColor="#00BFE9"></asp:Label>【<font style="color: #00BFE9">对延时发货的买家,自动发送短信进行安抚：默认对1天前买家已付款未发货的订单进行提醒</font>】
                     </div>
                    <div class="contt4 delay contt4_2">
                        <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 20%; vertical-align: middle">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:RadioButton ID="rdoDelayShipCus" GroupName="rdodelay" Text="我要自己设置提醒内容【<font color=red>提醒内容可选参数：**收货人**|**快递单号**</font>】<font color=#00BFE9>自定义提醒内容设置后请联系客服备案，否则不成功！<font color=red>" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="title2 arrived contt4_2">
                     <asp:Label ID="Label14" runat="server" Text="到达提醒" Font-Bold="true" Font-Size="12pt"
                                ForeColor="#00BFE9"></asp:Label>【<font style="color: #00BFE9">快递达到买家所在城市，自动发送短信给买家</font>】
                     </div>
                    <div class="contt4 arrived contt4_2">
                    <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 20%; vertical-align: middle">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:RadioButton ID="RadioButton7" GroupName="111" Text="我要自己设置提醒内容【<font color=red>提醒内容可选参数：**当前位置**|**快递公司**|**收货人**</font>】<font color=#00BFE9>自定义提醒内容设置后请联系客服备案，否则不成功！<font color=red>" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="title2 Sign contt4_2">
                       <asp:Label ID="Label16" runat="server" Text="签收提醒" Font-Bold="true" Font-Size="12pt"
                                ForeColor="#00BFE9"></asp:Label>【<font style="color: #00BFE9">买家签收后，自动发送短信给买家</font>】
                     </div>
                    <div class="contt4 Sign contt4_2">
                    <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 20%; vertical-align: middle">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:RadioButton ID="rdoSignCus" GroupName="21" Text="我要自己设置提醒内容【<font color=red>提醒内容可选参数：**收货人**</font>】<font color=#00BFE9>自定义提醒内容设置后请联系客服备案，否则不成功！<font color=red>" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="title2 receivable contt4_2">
                    <asp:Label ID="Label22" runat="server" Text="回款提醒" Font-Bold="true" Font-Size="12pt"
                                ForeColor="#00BFE9"></asp:Label>【<font style="color: #00BFE9">对买家已签收还未确认收货的订单,系统会自动发短信提醒买家确认收货.默认对签收5小时未确认的买家发送提醒</font>】
                     </div>
                    <div class="contt4 receivable contt4_2">
                    <table>
                                <tbody>
                                    <tr>
                                        <td style="width: 20%; vertical-align: middle">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:RadioButton ID="rdoHuiZJCus" GroupName="huizj" Text="我要自己设置提醒内容【<font color=red>提醒内容可选参数：**收货人**</font>】<font color=#00BFE9>自定义提醒内容设置后请联系客服备案，否则不成功！<font color=red>" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
