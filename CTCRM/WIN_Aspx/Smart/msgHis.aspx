<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="msgHis.aspx.cs" Inherits="CTCRM.WIN_Aspx.Smart.msgHis" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder1_grdBuyer >*
        {
            border:none;
        }
    </style>
            ...
            <div class="homediv">
                ...
                <div class="righter">
                    <div class="pDiv2">
                        <div class="div_zhandian">
                            <span class="zhandian">智能营销 >> 发送记录</span>
                        </div>
                        <div class="contt4">
                            <div class="div_tishi" style="color: #00BFE9;">
                            <p>温馨提示:该记录为物流提醒短信发送历史数据</p>
                        </div> 
                            <table class="his_tb" border="0" cellpadding="0" cellspacing="0" style="margin-top:10px;">
                                <tr>
                                    <td style="text-align: left; background-color: white; height: 30px; line-height: 30px;">
                ...
                <input runat="server" type="text" class="ui-widget-content ui-corner-all" onclick="WdatePicker()"
                    id="datePickerEnd" />
                        ...
                        OnClick="btnMsgSend_Click" class="img01" />--%>
                                        <asp:Button ID="bt_search" runat="server" Text="搜索" OnClientClick="dialog.DOpen2(this);" OnClick="bt_search_Click" CssClass="img01" BorderStyle="None" Width="61px"  />
                                    </td>
                                </tr>
                            </table>
                                ...
                                <EmptyDataTemplate>
                                    <table cellspacing="0" rules="all" border="1" id="ctl00_ContentPlaceHolder1_grdBuyer" class="table2"
                                        ...
                                        <tr style="border:none">
                                            <td colspan="5" style="border:none">当前没有发送明细
                                            </td>
                                        </tr>
                                    </table>
                                </EmptyDataTemplate>
