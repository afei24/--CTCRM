                ...
                <div class="pDiv2">
                    ...
                    <div class="contt4">
                        <div class="div_tishi" style="border:solid 1px #00BFE9">
                            ...
                            <p >2.因为淘宝接口只支持获取近三个月订单，如果要向更多的客户发送短信，需要手动导入当前店铺三个月前的订单数据。</p>
                            <p ">3.导入时系统会自动过滤 重复客户，故不会产生客户重复的现象。</p>
                            <p >4.在淘宝处理完成后，一定要点击后面的“下载订单报表”。</p>
                            <p >5.最大可上传文件大小为20M，超过20M请在淘宝导出的时候分时间段导出！</p><br />
                        </div>
                    <div id="Div1">
                        ...
                        <tbody class="syn">
                            <tr>
                                ...
                                <td align="center" valign="top" style="padding-right:0;background-color:white;">
                                    ...
                                    <div style="height: 114px; padding-top:50px;background-color:white;border:1px solid #F5F5F5;">
